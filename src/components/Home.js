...
export default function Home() {
    ...
    return (
        <>
            {/*   Carpousel   */}
            <div id="carouselExampleInterval" className="carousel slide carousel carousel-dark slide my-2 p-2 border border-dark-subtle" data-bs-ride="carousel" style={{...(mode.theme==="light"?{boxShadow: "0 10px 50px rgba(0, 0, 0, 0.9)"}:{boxShadow: "0 10px 50px rgba(167, 163, 163, 0.6)"}) }}>
